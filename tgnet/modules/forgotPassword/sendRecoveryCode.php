	...
	if(isset($_POST['submit'])){
		...
		$recoveryCode=$_POST['recoveryCode'];
                ...
                if ($recoveryCode==$_SESSION['code']) {
					...
					$message = "Wrong recovery code.Try again!";
	...
	<div class="container-fluid" id="main">
		...
		<div class="row" id="content">
			...
			<div class="login-card"><img src="../../img/avatar_2x.png" class="profile-img-card">
				...
				<form class="form-signin" action="" method="post"><span class="reauth-email"> </span>
					<input class="form-control" type="text" name="recoveryCode" required="" placeholder="Recovery Code" autofocus="" id="recoveryCode">
					<button class="btn btn-primary btn-block btn-lg btn-signin" type="submit" name="submit" value="submit">Submit</button>
