	...
	<div id="main" class="container-fluid">
		<div class="row" id="content">
			...
			<div class="col-md-8" id="writing">
				 <form name ="revenueForm" action="getMonthlyReport.php"  method="post" target="_blank">
					  <h2 >Input Form</h2>
					  
					  <p>      
						<label ><b>Choose a month</b></label>
					  <input class="w3-input w3-border" name="month" type="month" required></p>
					  <p> 
